...
#include <ira_merge_laser_tools/laserscan_multi_merger_combinedConfig.h>

using namespace std;
using namespace pcl;
using namespace laserscan_multi_merger_combined;
...
class LaserscanMerger
{
	public:
		...
		void reconfigureCallback(laserscan_multi_merger_combinedConfig &config, uint32_t level);
...
void LaserscanMerger::reconfigureCallback(laserscan_multi_merger_combinedConfig &config, uint32_t level)
{
...
int main(int argc, char **argv)
{
	...
	dynamic_reconfigure::Server<laserscan_multi_merger_combinedConfig> server;
	dynamic_reconfigure::Server<laserscan_multi_merger_combinedConfig>::CallbackType f;
